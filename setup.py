...
__version__ = None
exec(open("a2tg/version.py", "r").read())

URL = "https://github.com/Rickyeeeeee/A2TG"
...
def get_extensions():
    ...
    extensions_dir_v2 = osp.join("a2tg", "cuda", "csrc")
    ...
    if sys.platform == "win32":
        define_macros += [("a2tg_EXPORTS", None)]
    ...
    glm_path = os.path.join(current_dir, "a2tg", "cuda", "csrc", "third_party", "glm")
...
setup(
    name="a2tg",
    version=__version__,
    description=" Python package for differentiable rasterization of a2tg",
    keywords="gaussian, splatting, cuda",
    url=URL,
    download_url=f"{URL}/archive/a2tg-{__version__}.tar.gz",
    python_requires=">=3.7",
    install_requires=[
        "ninja",
        "numpy",
    ...
    extras_require={
        # dev dependencies. Install them by `pip install a2tg[dev]`
        "dev": [
